...
# تنظیمات پیش‌فرض برای اطلاعات شرکت
...
ORGANIZATION_NAME=${ORGANIZATION_NAME:-"MICROMODERN"}
...
# تولید سرتیفیکیت‌ها با اطلاعات شرکت
...
# حذف کانفیگ‌های قدیمی که در domains.list وجود ندارند
